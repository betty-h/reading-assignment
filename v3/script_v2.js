...
const articles = [
    {
        ...
        content: `
            ...
            <p>AI recommender system engines can observe and learn from an individual’s purchase behavior, noticing patterns that will help provide the user with the content suggestions that will most likely match his or her interests. This is what the ad recommender systems in Google and Facebook are trying to do, or in Netflix when recommending movies and TV shows. </p>
            <h3>Personalized Banking</h3>
            <p>As a mass market product that is consumed digitally by millions, banking is a prime arena for recommender systems. Knowing a customer’s detailed financial situation and their past preferences, coupled by data of thousands of similar users, makes a recommender system quite powerful.</p>
        ...
        questions: [
            {
                prompt: `Which of the following statements about recommender systems is NOT mentioned in the passage?`,
                options: [
            ...
            {
                prompt: `According to the passage, why is banking considered a strong use case for recommender systems?`,
                options: [
    ...
    },
    {
        ...
        content: `
            ...
            <h2>Amazon’s Amazing Recommender System</h2>
    ...
    },
    {
        ...
        content: `
            ...
            <p>That’s the business model. So how do these recommender systems think?</p>
        ...
        questions: [
            ...
            {
                prompt: "Why are the large “multidimensional tables” used by recommender systems described as “sparse”?",
                options: [
