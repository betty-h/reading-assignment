...
const articles = [
    {
        ...
        content: `
            ...
            <p><b>Hybrid recommender systems</b> combine the advantages of the types of algorithms above for a more comprehensive recommendation system.</p>
    ...
    },
    {
        ...
        content: `
          ...
          <p>Recommender systems are algorithms which analyze large datasets to identify patterns and show correlations of users with content, other users—or both. With enough data, these systems can be used to find some combination of factors that match your behavior and preferences.</p>
          ...
          <p>You might think the companies with highly accurate recommender systems have some ‘secret sauce’ under the hood that makes them best-in-class. But that’s not actually the case, said Goodwin. Instead, the companies doing this right excel at generating great data and have user bases that are highly receptive to recommendations.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p class="subtitle">Online giants are leveraging deep learning-based recommender systems to drive growth.</p>
